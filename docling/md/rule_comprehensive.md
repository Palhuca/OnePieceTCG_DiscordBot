...
- 6-2-1. Currently applied effects that last ' u ntil the start of your next turn' end.
- 6-2-2. Your  own  and  your  opponent's  e ffects  that  read 'at  the  start  of  your/your opponent's turn' activate.
...
- (2) Process  any  continuous  effects  of  the  non-turn  player  that  have  been activated and resolved, but are only due to be processed 'at the end of this turn' or 'at the end of your opponent ' s turn' . The nonturn player's effects that last 'until the end of the turn' and 'until the end of the End Phase' become invalid. If there are multiple such processes, the non-turn player may process them in any order.
...
- 7-1-5-2. Your own and your opponent's e ffects that read ' at the end of the/this battle ' or 'if this ... battles' activate.
...
- 8-1. Effects
- 8-1-1. 'E ffect ' refers to a command issued by the text of a card and its cost.
